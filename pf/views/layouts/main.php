...
<div id="style-switcher" class="bg-light border p-3 pt-2 pb-2" onclick="toggleSwitcher()">
    <div>
        <h6 class="title text-center">Rangingizni tanlang</h6>
        <ul class="pattern">
        ...
        <h6 class="title text-center pt-3 mb-0 border-top">Mavzu opsiyasi</h6>
        <ul class="text-center list-unstyled">
            ...
            <li class="d-grid"><a href="javascript:void(0)" class="btn btn-sm btn-block btn-dark dark-version t-dark mt-2" onclick="setTheme('style-dark')">Qorong'ulik</a></li>
            <li class="d-grid"><a href="javascript:void(0)" class="btn btn-sm btn-block btn-dark light-version t-light mt-2" onclick="setTheme('style')">Yorugʻlik</a></li>
        </ul>
    </div>
    <div class="bottom">
