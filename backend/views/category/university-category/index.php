...
/* @var $searchForm UniversityCategorySearchForm */
        ...
        'columns' => [
            ...
            [
                ...
                'filter' => Select2::widget([
                        'model' => $searchForm,
                        'attribute' => 'status',
                        'data' =>  ArrayHelper::map(UniversityCategoryStatus::getStatusForSelect(), 'id', 'value'),
                        'options' => [
                            'id' => 'status',
                            'prompt' => Yii::t('app', '...')],
                        'pluginOptions' => [
                ...
                'value'     => function ($data) {
                    if ($data->id) {
                        return UniversityCategoryStatus::getStatusHtml($data, 'index');
                    }
                },
            ],
            [
