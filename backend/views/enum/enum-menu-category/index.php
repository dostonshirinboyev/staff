...
/* @var $searchForm EnumMenuCategorySearchForm */
/* @var $dataProvider ActiveDataProvider */

$this->title = Yii::t('app', 'Menyu kategoriyalari');
    ...
    <div class="box box-info">
        ...
        'columns' => [
            ...
            [
                ...
                'filterOptions' => ['width' => '30%'],
                'contentOptions' => ['width' => '30%'],
                'format' => 'html',
                'value' => function ($data) {
                    return Html::a($data->title_oz, ['enum/enum-menu-category/view', 'id' => $data->id]);
                },
            ],
            [
                'attribute' => 'code_name',
            ...
            [
                'header'=> Html::a(Yii::t('app','Boshqarish menyusi')),
                'headerOptions' => ['class' => 'text-center', 'width' => '10%'],
                'filterOptions' => ['class' => 'text-center', 'width' => '10%'],
                'contentOptions' => ['class' => 'text-center', 'width' => '10%'],
